...
<div class="page-content">
    ...
    <h4 class="text-center text-secondary">LISTA DE EMPLEADOS VADUM</h4>
	...
	asistencia_vadum.empleado.id_empleado, 
	asistencia_vadum.empleado.nombre, 
	asistencia_vadum.empleado.apellido, 
	asistencia_vadum.empleado.dni, 
	asistencia_vadum.empleado.cargo, 
	asistencia_vadum.cargo.nombre as'nom_cargo'
FROM
	asistencia_vadum.empleado
	INNER JOIN
	asistencia_vadum.cargo
	ON 
		asistencia_vadum.empleado.cargo = asistencia_vadum.cargo.id_cargo ");
            ...
            while ($datos = $sql->fetch_object()) { ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="empleado.php?id=<?= $datos->id_empleado
                         ?>" onclick="advertencia(event)" class="btn btn-danger btn-sm"><i class="fa-solid fa-trash"></i></a>
                    </td>
                </tr>


                <!-- Modal -->
                <div class="modal fade" id="exampleModal<?= $datos->id_empleado
