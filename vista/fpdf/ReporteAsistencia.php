...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Image('logo.png', 250, 0, 50); //logo de la empresa,moverDerecha,moverAbajo,tamañoIMG
      ...
      $this->Cell(85, 10, utf8_decode("REPORTE DE ASISTENCIAS "), 0, 1, 'C', 0);
      $this->Ln(7);

      /* CAMPOS DE LA TABLA */
      //color
      $this->SetFillColor(161, 161, 161); //colorFondo
